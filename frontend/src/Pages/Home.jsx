...
<p className='text-xl text-white mt-5'>
      ...
      <p onClick={()=>setNewChatBox(!newChatBox)} className='bg-secondary w-1/4 text-white px-1 py-2 mt-5 text-sm font-semibold rounded-lg hover:text-primary hover:bg-secondary text-center cursor-pointer'>
        New Chat
      </p>
                        ...
                        onChange={(e)=>setCode(e.target.value)}
                         ...
                         <button className='text-gray-500 mt-5 mx-2 font-bold text-lg' onClick={handleRoomJoin}>join</button>
